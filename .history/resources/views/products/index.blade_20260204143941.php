...
<body>
    ...
    // Always add text fields manually (prevents multipart issues on PUT)
    ...
    // For PUT/PATCH, Laravel needs _method spoofing when using multipart
    if (isEdit) {
    ...
    $.ajax({
        ...
        headers: { 
            ...
            // Do NOT set X-CSRF-TOKEN header when using FormData — it's already in formData
        },
